...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sandbox'
        db.create_table(u'sandboxes_sandbox', (
        ...
        db.send_create_signal(u'sandboxes', ['Sandbox'])

        # Adding model 'SandboxLog'
        db.create_table(u'sandboxes_sandboxlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sandbox', self.gf('django.db.models.fields.related.OneToOneField')(related_name='log', unique=True, to=orm['sandboxes.Sandbox'])),
            ('return_code', self.gf('django.db.models.fields.IntegerField')()),
            ('logs', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'sandboxes', ['SandboxLog'])


    def backwards(self, orm):
        # Deleting model 'Sandbox'
        db.delete_table(u'sandboxes_sandbox')

        # Deleting model 'SandboxLog'
        db.delete_table(u'sandboxes_sandboxlog')
