...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sandbox.docker_server'
        db.add_column(u'sandboxes_sandbox', 'docker_server',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DockerServer'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sandbox.docker_server'
        db.delete_column(u'sandboxes_sandbox', 'docker_server_id')
