...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DockerServer.bucket_list'
        db.add_column(u'common_dockerserver', 'bucket_list',
                      self.gf('django.db.models.fields.CharField')(default='/etc/opendevelop/buckets', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DockerServer.bucket_list'
        db.delete_column(u'common_dockerserver', 'bucket_list')
